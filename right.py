...
left_comp_ip = '192.168.56.103'
middle_comp_ip = '192.168.56.101'
right_comp_ip = '192.168.56.102'
...
def updata_score(pleyer):
    ...
    if pleyer == "right":
        PLAYER_2_SCORE += 1
        c.itemconfigure(p_2_text, text=PLAYER_2_SCORE)
...
p_2_text = c.create_text(WIDTH - WIDTH / 6, PAD_H / 4, text=PLAYER_2_SCORE, font="Arial 20", fill="yellow")
